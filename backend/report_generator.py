...
<body>
  ...
  <div class="footer">
    Generated by AI Visualizer Predictive Analytics · {generated_at}
  </div>
</body>
</html>"""
...
def generate_pdf_report(report_data: dict) -> bytes:
    ...
    story.append(Paragraph(f"Generated by AI Visualizer Predictive Analytics · {generated_at}", small_style))
